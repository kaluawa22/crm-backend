...
from .serializers import CategorySerializers, LeadSerializers, AgentSerializers
...
class CategoryList(LoginRequiredMixin, viewsets.ModelViewSet):
...
class AgentList(OrganizorAndLoginRequiredMixin, viewsets.ModelViewSet):
